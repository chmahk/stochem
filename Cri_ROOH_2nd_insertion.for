...
C----------------------------------------------------------------------
     ...
     & P1046       , P1047       , APCH3OOH    , BPHOC2H4O   ,
     & APCH3CO3H   , APC2H5CO3   , BPHOCH2CO3  , APHOCH2CO3  ,
     & BPRN8OOH    , BPRTN10OO   , AP2CH3OOH   , BP2HOC2H4O  ,
     & AP2CH3CO3   , AP2C2H5CO   , BP2HOCH2CO  , AP2HOCH2CO  ,
     & BP2RU14OO   , C12RU12OO   , IS2RU12OO   , BP2RU10OO   ,
     & BP2NRU14O   , IS2NRU12OO  , IS2RTN28OO  , BP2RTN28OO  ,
     & IS2RTN26OO  , BP2RTN26OO  , BP2RTN25OO  , IS2RTN24OO  ,
     & C12RTN23OO  , IS2RTN23OO  , IS2NRTN28O  , BP2NRTN28O  ,
     & BP2RN8OOH   , AP2RN8OOH   , IS2RTX28OO  , BP2RTX28OO  ,
     & BP2RTX24OO  , IS2RTX22OO  , BP2RTX22OO  , IS2NRTX28O  ,
     & IS2RTN14OO  , BP2RTN10OO  , AP2RTN10OO  , P1048       ,
     & P1049       , P1050       , P1051       , P1052       ,
     & P1053       , P1054       , P1055       , P1056       ,
     & P1057       , P1058       , P1059       , P1060       ,
     & P1061       , P1062       , P1063       , P1064       ,
     & P1065       , P1066       , P1067       , P1068       ,
     & P1069       , P1070       , P1071       , P1072       ,
     & P1073       , P1074       , P1075       , P1076       ,
...
C     
	SOA(JB) = Y(JB,204)*3.574E-10 + Y(JB,205)*3.574E-10 + 
     ...
     & Y(JB,341)*3.474E-10 + Y(JB,342)*3.313E-10 + Y(JB,384)*4.160E-10 +
     & Y(JB,385)*3.874E-10 + Y(JB,386)*4.450E-10 + Y(JB,387)*4.570E-10 +
     & Y(JB,388)*4.010E-10 + Y(JB,389)*4.610E-10 + Y(JB,390)*4.270E-10 +
     & Y(JB,391)*2.420E-10 + Y(JB,392)*3.220E-10 + Y(JB,393)*4.290E-10 +
     & Y(JB,394)*4.720E-10 + Y(JB,395)*3.670E-10 + Y(JB,396)*3.580E-10 +
     & Y(JB,397)*4.950E-10 + Y(JB,398)*3.720E-10 + Y(JB,399)*5.090E-10 +
     & Y(JB,400)*4.810E-10 + Y(JB,401)*3.600E-10 + Y(JB,402)*2.960E-10 +
     & Y(JB,403)*3.760E-10 + Y(JB,404)*4.030E-10 + Y(JB,405)*5.400E-10 +
     & Y(JB,406)*4.130E-10 + Y(JB,407)*4.730E-10 + Y(JB,408)*3.580E-10 +
     & Y(JB,409)*4.950E-10 + Y(JB,410)*4.790E-10 + Y(JB,411)*3.580E-10 +
     & Y(JB,412)*4.950E-10 + Y(JB,413)*4.030E-10 + Y(JB,414)*3.340E-10 +
     & Y(JB,415)*4.550E-10 + Y(JB,416)*5.150E-10 
C
...
C          OH               Y(JB,  3)
     ...
     &+(RC(JB,720)    *Y(JB,249))+(RC(JB,721)    *Y(JB,250))  
     &+(RC(JB,722)    *Y(JB,251))+(RC(JB,723)    *Y(JB,252)) 
     &+(RC(JB,724)    *Y(JB,253))+(RC(JB,725)    *Y(JB,254)) 
     &+(RC(JB,726)    *Y(JB,255))+(RC(JB,727)    *Y(JB,256)) 
     &+(RC(JB,728)    *Y(JB,257))+(RC(JB,729)    *Y(JB,258)) 
     &+(RC(JB,730)    *Y(JB,259))+(RC(JB,731)    *Y(JB,260)) 
     &+(RC(JB,732)    *Y(JB,261))+(RC(JB,733)    *Y(JB,262)) 
     &+(RC(JB,734)    *Y(JB,263))+(RC(JB,735)    *Y(JB,264)) 
     &+(RC(JB,736)    *Y(JB,265))+(RC(JB,737)    *Y(JB,266)) 
     &+(RC(JB,738)    *Y(JB,267))+(RC(JB,739)    *Y(JB,268)) 
     &+(RC(JB,740)    *Y(JB,269))+(RC(JB,741)    *Y(JB,270)) 
     &+(RC(JB,742)    *Y(JB,271))+(RC(JB,743)    *Y(JB,272)) 
     &+(RC(JB,744)    *Y(JB,273))+(RC(JB,745)    *Y(JB,274)) 
     &+(RC(JB,746)    *Y(JB,275))+(RC(JB,747)    *Y(JB,276)) 
     &+(RC(JB,748)    *Y(JB,277))+(RC(JB,749)    *Y(JB,278)) 
     &+(RC(JB,750)    *Y(JB,279))+(RC(JB,751)    *Y(JB,280)) 
     &+(RC(JB,752)    *Y(JB,281))+(RC(JB,753)    *Y(JB,282)) 
     &+(RC(JB,754)    *Y(JB,283))+(RC(JB,755)    *Y(JB,284)) 
     &+(RC(JB,756)    *Y(JB,285))+(RC(JB,757)    *Y(JB,286)) 
     &+(RC(JB,758)    *Y(JB,287))+(RC(JB,759)    *Y(JB,288)) 
     &+(RC(JB,760)    *Y(JB,289))+(RC(JB,761)    *Y(JB,290)) 
     &+(RC(JB,762)    *Y(JB,291))+(RC(JB,763)    *Y(JB,292)) 
     &+(RC(JB,764)    *Y(JB,293))+(RC(JB,765)    *Y(JB,294)) 
     &+(RC(JB,766)    *Y(JB,295))
      Y(JB,  3) = P/L
C
C          NO2              Y(JB,  4)
...
C          APCH3OOH          Y(JB,343)
      P = 0.0
     &+(RC(JB,767)    *Y(JB,144 )*APN(JB))                                      
      L = 0.0
     &+(RC(JB,775)    *Y(JB,3  ))+(DJ(JB,144)     )                               
      Y(JB,343) = (YP(JB,343)+DTS*P)/(1.0+DTS*L)
C          BPHOC2H4OOH          Y(JB,344)
      P = 0.0
     &+(RC(JB,768)    *Y(JB,154 )*BPN(JB))                                      
      L = 0.0
     &+(RC(JB,776)    *Y(JB,3  ))+(DJ(JB,145)     )                               
      Y(JB,344) = (YP(JB,344)+DTS*P)/(1.0+DTS*L)
C          APCH3CO3H          Y(JB,345)
      P = 0.0
     &+(RC(JB,769)    *Y(JB,159 )*APN(JB))                                      
      L = 0.0
     &+(RC(JB,777)    *Y(JB,3  ))+(DJ(JB,146)     )                               
      Y(JB,345) = (YP(JB,345)+DTS*P)/(1.0+DTS*L)
C          APC2H5CO3H          Y(JB,346)
      P = 0.0
     &+(RC(JB,770)    *Y(JB,160 )*APN(JB))                                      
      L = 0.0
     &+(RC(JB,778)    *Y(JB,3  ))+(DJ(JB,147)     )                               
      Y(JB,346) = (YP(JB,346)+DTS*P)/(1.0+DTS*L)
C          BPHOCH2CO3H          Y(JB,347)
      P = 0.0
     &+(RC(JB,771)    *Y(JB,161 )*BPN(JB))                                      
      L = 0.0
     &+(RC(JB,779)    *Y(JB,3  ))+(DJ(JB,148)     )                               
      Y(JB,347) = (YP(JB,347)+DTS*P)/(1.0+DTS*L)
C          APHOCH2CO3H          Y(JB,348)
      P = 0.0
     &+(RC(JB,772)    *Y(JB,161 )*APN(JB))                                      
      L = 0.0
     &+(RC(JB,780)    *Y(JB,3  ))+(DJ(JB,149)     )                               
      Y(JB,348) = (YP(JB,348)+DTS*P)/(1.0+DTS*L)
C          BPRN8OOH          Y(JB,349)
      P = 0.0
     &+(RC(JB,773)    *Y(JB,162 )*BPN(JB))                                      
      L = 0.0
     &+(RC(JB,781)    *Y(JB,3  ))+(DJ(JB,150)     )                               
      Y(JB,349) = (YP(JB,349)+DTS*P)/(1.0+DTS*L)
C          BPRN10OOH          Y(JB,350)
      P = 0.0
     &+(RC(JB,774)    *Y(JB,181 )*BPN(JB))                                      
      L = 0.0
     &+(RC(JB,782)    *Y(JB,3  ))+(DJ(JB,151)     )                               
      Y(JB,350) = (YP(JB,350)+DTS*P)/(1.0+DTS*L)
C          AP2CH3OOH          Y(JB,351)
      P = 0.0
     &+(RC(JB,783)    *Y(JB,343)*APN(JB))
     &+(RC(JB,817)    *Y(JB,384))                                     
      L = 0.0
     &+(RC(JB,882)    *Y(JB,3  ))+(DJ(JB,152)     )  
     &+(RC(JB,816)    )                             
      Y(JB,351) = (YP(JB,351)+DTS*P)/(1.0+DTS*L)
C          BP2HOC2H4OOH          Y(JB,352)
      P = 0.0
     &+(RC(JB,784)    *Y(JB,344)*BPN(JB))
     &+(RC(JB,819)    *Y(JB,385))                                     
      L = 0.0
     &+(RC(JB,883)    *Y(JB,3  ))+(DJ(JB,153)     )  
     &+(RC(JB,818)    )                             
      Y(JB,352) = (YP(JB,352)+DTS*P)/(1.0+DTS*L)
C          AP2CH3CO3H          Y(JB,353)
      P = 0.0
     &+(RC(JB,785)    *Y(JB,345)*APN(JB))
     &+(RC(JB,821)    *Y(JB,386))                                     
      L = 0.0
     &+(RC(JB,884)    *Y(JB,3  ))+(DJ(JB,154)     )  
     &+(RC(JB,820)    )                             
      Y(JB,353) = (YP(JB,353)+DTS*P)/(1.0+DTS*L)
C          AP2C2H5CO3H          Y(JB,354)
      P = 0.0
     &+(RC(JB,786)    *Y(JB,346)*APN(JB))
     &+(RC(JB,823)    *Y(JB,387))                                     
      L = 0.0
     &+(RC(JB,885)    *Y(JB,3  ))+(DJ(JB,155)     )  
     &+(RC(JB,822)    )                             
      Y(JB,354) = (YP(JB,354)+DTS*P)/(1.0+DTS*L)
C          BP2HOCH2CO3H          Y(JB,355)
      P = 0.0
     &+(RC(JB,787)    *Y(JB,347)*BPN(JB))
     &+(RC(JB,825)    *Y(JB,388))                                     
      L = 0.0
     &+(RC(JB,886)    *Y(JB,3  ))+(DJ(JB,156)     )  
     &+(RC(JB,824)    )                             
      Y(JB,355) = (YP(JB,355)+DTS*P)/(1.0+DTS*L)
C          AP2HOCH2CO3H          Y(JB,356)
      P = 0.0
     &+(RC(JB,788)    *Y(JB,348)*APN(JB))
     &+(RC(JB,827)    *Y(JB,389))                                     
      L = 0.0
     &+(RC(JB,887)    *Y(JB,3  ))+(DJ(JB,157)     )  
     &+(RC(JB,826)    )                             
      Y(JB,356) = (YP(JB,356)+DTS*P)/(1.0+DTS*L)
C          BP2RU14OOH          Y(JB,357)
      P = 0.0
     &+(RC(JB,789)    *Y(JB,250)*BPN(JB))
     &+(RC(JB,829)    *Y(JB,390))                                     
      L = 0.0
     &+(RC(JB,888)    *Y(JB,3  ))+(DJ(JB,158)     )  
     &+(RC(JB,828)    )                             
      Y(JB,357) = (YP(JB,357)+DTS*P)/(1.0+DTS*L)
C          C1_2RU12OOH          Y(JB,358)
      P = 0.0
     &+(RC(JB,790)    *Y(JB,252)*Y(JB,230))
     &+(RC(JB,831)    *Y(JB,391))                                     
      L = 0.0
     &+(RC(JB,889)    *Y(JB,3  ))+(DJ(JB,159)     )  
     &+(RC(JB,830)    )                             
      Y(JB,358) = (YP(JB,358)+DTS*P)/(1.0+DTS*L)
C          IS2RU12OOH          Y(JB,359)
      P = 0.0
     &+(RC(JB,791)    *Y(JB,253)*ISP(JB))
     &+(RC(JB,833)    *Y(JB,392))                                     
      L = 0.0
     &+(RC(JB,890)    *Y(JB,3  ))+(DJ(JB,160)     )  
     &+(RC(JB,832)    )                             
      Y(JB,359) = (YP(JB,359)+DTS*P)/(1.0+DTS*L)
C          BP2RU10OOH          Y(JB,360)
      P = 0.0
     &+(RC(JB,792)    *Y(JB,255)*BPN(JB))
     &+(RC(JB,835)    *Y(JB,393))                                     
      L = 0.0
     &+(RC(JB,891)    *Y(JB,3  ))+(DJ(JB,161)     )  
     &+(RC(JB,834)    )                             
      Y(JB,360) = (YP(JB,360)+DTS*P)/(1.0+DTS*L)
C          BP2NRU14OOH          Y(JB,361)
      P = 0.0
     &+(RC(JB,793)    *Y(JB,257)*BPN(JB))
     &+(RC(JB,837)    *Y(JB,394))                                     
      L = 0.0
     &+(RC(JB,892)    *Y(JB,3  ))+(DJ(JB,162)     )  
     &+(RC(JB,836)    )                             
      Y(JB,361) = (YP(JB,361)+DTS*P)/(1.0+DTS*L)
C          IS2NRU12OOH          Y(JB,362)
      P = 0.0
     &+(RC(JB,794)    *Y(JB,260)*ISP(JB))
     &+(RC(JB,839)    *Y(JB,395))                                     
      L = 0.0
     &+(RC(JB,893)    *Y(JB,3  ))+(DJ(JB,163)     )  
     &+(RC(JB,838)    )                             
      Y(JB,362) = (YP(JB,362)+DTS*P)/(1.0+DTS*L)
C          IS2RTN28OOH          Y(JB,363)
      P = 0.0
     &+(RC(JB,795)    *Y(JB,262)*ISP(JB))
     &+(RC(JB,841)    *Y(JB,396))                                     
      L = 0.0
     &+(RC(JB,894)    *Y(JB,3  ))+(DJ(JB,164)     )  
     &+(RC(JB,840)    )                             
      Y(JB,363) = (YP(JB,363)+DTS*P)/(1.0+DTS*L)
C          BP2RTN28OOH          Y(JB,364)
      P = 0.0
     &+(RC(JB,796)    *Y(JB,263)*BPN(JB))
     &+(RC(JB,843)    *Y(JB,397))                                     
      L = 0.0
     &+(RC(JB,895)    *Y(JB,3  ))+(DJ(JB,165)     )  
     &+(RC(JB,842)    )                             
      Y(JB,364) = (YP(JB,364)+DTS*P)/(1.0+DTS*L)
C          IS2RTN26OOH          Y(JB,365)
      P = 0.0
     &+(RC(JB,797)    *Y(JB,265)*ISP(JB))
     &+(RC(JB,845)    *Y(JB,398))                                     
      L = 0.0
     &+(RC(JB,896)    *Y(JB,3  ))+(DJ(JB,166)     )  
     &+(RC(JB,844)    )                             
      Y(JB,365) = (YP(JB,365)+DTS*P)/(1.0+DTS*L)
C          BP2RTN26OOH          Y(JB,366)
      P = 0.0
     &+(RC(JB,798)    *Y(JB,266)*BPN(JB))
     &+(RC(JB,847)    *Y(JB,399))                                     
      L = 0.0
     &+(RC(JB,897)    *Y(JB,3  ))+(DJ(JB,167)     )  
     &+(RC(JB,846)    )                             
      Y(JB,366) = (YP(JB,366)+DTS*P)/(1.0+DTS*L)
C          BP2RTN25OOH          Y(JB,367)
      P = 0.0
     &+(RC(JB,799)    *Y(JB,268)*BPN(JB))
     &+(RC(JB,849)    *Y(JB,400))                                     
      L = 0.0
     &+(RC(JB,898)    *Y(JB,3  ))+(DJ(JB,168)     )  
     &+(RC(JB,848)    )                             
      Y(JB,367) = (YP(JB,367)+DTS*P)/(1.0+DTS*L)
C          IS2RTN24OOH          Y(JB,368)
      P = 0.0
     &+(RC(JB,800)    *Y(JB,270)*ISP(JB))
     &+(RC(JB,851)    *Y(JB,401))                                     
      L = 0.0
     &+(RC(JB,899)    *Y(JB,3  ))+(DJ(JB,169)     )  
     &+(RC(JB,850)    )                             
      Y(JB,368) = (YP(JB,368)+DTS*P)/(1.0+DTS*L)
C          C1_2RTN23OOH          Y(JB,369)
      P = 0.0
     &+(RC(JB,801)    *Y(JB,273)*Y(JB,230))
     &+(RC(JB,853)    *Y(JB,402))                                     
      L = 0.0
     &+(RC(JB,900)    *Y(JB,3  ))+(DJ(JB,170)     )  
     &+(RC(JB,852)    )                             
      Y(JB,369) = (YP(JB,369)+DTS*P)/(1.0+DTS*L)
C          IS2RTN23OOH          Y(JB,370)
      P = 0.0
     &+(RC(JB,802)    *Y(JB,274)*ISP(JB))
     &+(RC(JB,855)    *Y(JB,403))                                     
      L = 0.0
     &+(RC(JB,901)    *Y(JB,3  ))+(DJ(JB,171)     )  
     &+(RC(JB,854)    )                             
      Y(JB,370) = (YP(JB,370)+DTS*P)/(1.0+DTS*L)
C          IS2NRTN28OOH          Y(JB,371)
      P = 0.0
     &+(RC(JB,803)    *Y(JB,276)*ISP(JB))
     &+(RC(JB,857)    *Y(JB,404))                                     
      L = 0.0
     &+(RC(JB,902)    *Y(JB,3  ))+(DJ(JB,172)     )  
     &+(RC(JB,656)    )                             
      Y(JB,371) = (YP(JB,371)+DTS*P)/(1.0+DTS*L)
C          BP2NRTN28OOH          Y(JB,372)
      P = 0.0
     &+(RC(JB,804)    *Y(JB,277)*BPN(JB))
     &+(RC(JB,859)    *Y(JB,405))                                     
      L = 0.0
     &+(RC(JB,903)    *Y(JB,3  ))+(DJ(JB,173)     )  
     &+(RC(JB,858)    )                             
      Y(JB,372) = (YP(JB,372)+DTS*P)/(1.0+DTS*L)
C          BP2RN8OOH          Y(JB,373)
      P = 0.0
     &+(RC(JB,805)    *Y(JB,349)*BPN(JB))
     &+(RC(JB,861)    *Y(JB,406))                                     
      L = 0.0
     &+(RC(JB,904)    *Y(JB,3  ))+(DJ(JB,174)     )  
     &+(RC(JB,860)    )                             
      Y(JB,373) = (YP(JB,373)+DTS*P)/(1.0+DTS*L)
C          AP2RN8OOH          Y(JB,374)
      P = 0.0
     &+(RC(JB,806)    *Y(JB,279)*APN(JB))
     &+(RC(JB,863)    *Y(JB,407))                                     
      L = 0.0
     &+(RC(JB,905)    *Y(JB,3  ))+(DJ(JB,175)     )  
     &+(RC(JB,862)    )                             
      Y(JB,374) = (YP(JB,374)+DTS*P)/(1.0+DTS*L)
C          IS2RTX28OOH          Y(JB,375)
      P = 0.0
     &+(RC(JB,807)    *Y(JB,280)*ISP(JB))
     &+(RC(JB,865)    *Y(JB,408))                                     
      L = 0.0
     &+(RC(JB,906)    *Y(JB,3  ))+(DJ(JB,176)     )  
     &+(RC(JB,864)    )                             
      Y(JB,375) = (YP(JB,375)+DTS*P)/(1.0+DTS*L)
C          BP2RTX28OOH          Y(JB,376)
      P = 0.0
     &+(RC(JB,808)    *Y(JB,281)*BPN(JB))
     &+(RC(JB,867)    *Y(JB,409))                                     
      L = 0.0
     &+(RC(JB,907)    *Y(JB,3  ))+(DJ(JB,177)     )  
     &+(RC(JB,866)    )                             
      Y(JB,376) = (YP(JB,376)+DTS*P)/(1.0+DTS*L)
C          BP2RTX24OOH          Y(JB,377)
      P = 0.0
     &+(RC(JB,809)    *Y(JB,283)*BPN(JB))
     &+(RC(JB,869)    *Y(JB,410))                                     
      L = 0.0
     &+(RC(JB,908)    *Y(JB,3  ))+(DJ(JB,178)     )  
     &+(RC(JB,868)    )                             
      Y(JB,377) = (YP(JB,377)+DTS*P)/(1.0+DTS*L)
C          IS2RTX22OOH          Y(JB,378)
      P = 0.0
     &+(RC(JB,810)    *Y(JB,285)*ISP(JB))
     &+(RC(JB,871)    *Y(JB,411))                                     
      L = 0.0
     &+(RC(JB,909)    *Y(JB,3  ))+(DJ(JB,179)     )  
     &+(RC(JB,870)    )                             
      Y(JB,378) = (YP(JB,378)+DTS*P)/(1.0+DTS*L)
C          BP2RTX22OOH          Y(JB,379)
      P = 0.0
     &+(RC(JB,811)    *Y(JB,286)*BPN(JB))
     &+(RC(JB,873)    *Y(JB,412))                                     
      L = 0.0
     &+(RC(JB,910)    *Y(JB,3  ))+(DJ(JB,180)     )  
     &+(RC(JB,872)    )                             
      Y(JB,379) = (YP(JB,379)+DTS*P)/(1.0+DTS*L)
C          IS2NRTX28OOH          Y(JB,380)
      P = 0.0
     &+(RC(JB,812)    *Y(JB,288)*ISP(JB))
     &+(RC(JB,875)    *Y(JB,413))                                     
      L = 0.0
     &+(RC(JB,911)    *Y(JB,3  ))+(DJ(JB,181)     )  
     &+(RC(JB,874)    )                             
      Y(JB,380) = (YP(JB,380)+DTS*P)/(1.0+DTS*L)
C          IS2RTN14OOH          Y(JB,381)
      P = 0.0
     &+(RC(JB,813)    *Y(JB,292)*ISP(JB))
     &+(RC(JB,877)    *Y(JB,414))                                     
      L = 0.0
     &+(RC(JB,912)    *Y(JB,3  ))+(DJ(JB,182)     )  
     &+(RC(JB,876)    )                             
      Y(JB,381) = (YP(JB,381)+DTS*P)/(1.0+DTS*L)
C          BP2RTN10OOH          Y(JB,382)
      P = 0.0
     &+(RC(JB,814)    *Y(JB,350)*BPN(JB))
     &+(RC(JB,879)    *Y(JB,415))                                     
      L = 0.0
     &+(RC(JB,913)    *Y(JB,3  ))+(DJ(JB,183)     )  
     &+(RC(JB,878)    )                             
      Y(JB,382) = (YP(JB,382)+DTS*P)/(1.0+DTS*L)
C          AP2RTN10OOH          Y(JB,383)
      P = 0.0
     &+(RC(JB,815)    *Y(JB,295)*APN(JB))
     &+(RC(JB,881)    *Y(JB,416))                                     
      L = 0.0
     &+(RC(JB,914)    *Y(JB,3  ))+(DJ(JB,184)     )  
     &+(RC(JB,880)    )                             
      Y(JB,383) = (YP(JB,383)+DTS*P)/(1.0+DTS*L)
C          P1048            Y(JB,384)
      P = 0.0
     &+(RC(JB,816)    *Y(JB,351))                                             
      L = DD(JB,384)+ DW(JB,384)
     &+(RC(JB,817)    )                                                    
      Y(JB,384) = (YP(JB,384)+DTS*P)/(1.0+DTS*L)
C          P1049            Y(JB,385)
      P = 0.0
     &+(RC(JB,818)    *Y(JB,352))                                             
      L = DD(JB,385)+ DW(JB,385)
     &+(RC(JB,819)    )                                                    
      Y(JB,385) = (YP(JB,385)+DTS*P)/(1.0+DTS*L)
C          P1050            Y(JB,386)
      P = 0.0
     &+(RC(JB,820)    *Y(JB,353))                                             
      L = DD(JB,386)+ DW(JB,386)
     &+(RC(JB,821)    )                                                    
      Y(JB,386) = (YP(JB,386)+DTS*P)/(1.0+DTS*L)
C          P1051            Y(JB,387)
      P = 0.0
     &+(RC(JB,822)    *Y(JB,354))                                             
      L = DD(JB,387)+ DW(JB,387)
     &+(RC(JB,823)    )                                                    
      Y(JB,387) = (YP(JB,387)+DTS*P)/(1.0+DTS*L)
C          P1052            Y(JB,388)
      P = 0.0
     &+(RC(JB,824)    *Y(JB,355))                                             
      L = DD(JB,388)+ DW(JB,388)
     &+(RC(JB,825)    )                                                    
      Y(JB,388) = (YP(JB,388)+DTS*P)/(1.0+DTS*L)
C          P1053            Y(JB,389)
      P = 0.0
     &+(RC(JB,826)    *Y(JB,356))                                             
      L = DD(JB,389)+ DW(JB,389)
     &+(RC(JB,827)    )                                                    
      Y(JB,389) = (YP(JB,389)+DTS*P)/(1.0+DTS*L)
C          P1054            Y(JB,390)
      P = 0.0
     &+(RC(JB,828)    *Y(JB,357))                                             
      L = DD(JB,390)+ DW(JB,390)
     &+(RC(JB,829)    )                                                    
      Y(JB,390) = (YP(JB,390)+DTS*P)/(1.0+DTS*L)
C          P1055            Y(JB,391)
      P = 0.0
     &+(RC(JB,830)    *Y(JB,358))                                             
      L = DD(JB,391)+ DW(JB,391)
     &+(RC(JB,831)    )                                                    
      Y(JB,391) = (YP(JB,391)+DTS*P)/(1.0+DTS*L)
C          P1056            Y(JB,392)
      P = 0.0
     &+(RC(JB,832)    *Y(JB,359))                                             
      L = DD(JB,392)+ DW(JB,392)
     &+(RC(JB,833)    )                                                    
      Y(JB,392) = (YP(JB,392)+DTS*P)/(1.0+DTS*L)
C          P1057            Y(JB,393)
      P = 0.0
     &+(RC(JB,834)    *Y(JB,360))                                             
      L = DD(JB,393)+ DW(JB,393)
     &+(RC(JB,835)    )                                                    
      Y(JB,393) = (YP(JB,393)+DTS*P)/(1.0+DTS*L)
C          P1058            Y(JB,394)
      P = 0.0
     &+(RC(JB,836)    *Y(JB,361))                                             
      L = DD(JB,394)+ DW(JB,394)
     &+(RC(JB,837)    )                                                    
      Y(JB,394) = (YP(JB,394)+DTS*P)/(1.0+DTS*L)
C          P1059            Y(JB,395)
      P = 0.0
     &+(RC(JB,838)    *Y(JB,362))                                             
      L = DD(JB,395)+ DW(JB,395)
     &+(RC(JB,839)    )                                                    
      Y(JB,395) = (YP(JB,395)+DTS*P)/(1.0+DTS*L)
C          P1060            Y(JB,396)
      P = 0.0
     &+(RC(JB,840)    *Y(JB,363))                                             
      L = DD(JB,396)+ DW(JB,396)
     &+(RC(JB,841)    )                                                    
      Y(JB,396) = (YP(JB,396)+DTS*P)/(1.0+DTS*L)
C          P1061            Y(JB,397)
      P = 0.0
     &+(RC(JB,842)    *Y(JB,364))                                             
      L = DD(JB,397)+ DW(JB,397)
     &+(RC(JB,843)    )                                                    
      Y(JB,397) = (YP(JB,397)+DTS*P)/(1.0+DTS*L)
C          P1062            Y(JB,398)
      P = 0.0
     &+(RC(JB,844)    *Y(JB,365))                                             
      L = DD(JB,398)+ DW(JB,398)
     &+(RC(JB,845)    )                                                    
      Y(JB,398) = (YP(JB,398)+DTS*P)/(1.0+DTS*L)
C          P1063            Y(JB,399)
      P = 0.0
     &+(RC(JB,846)    *Y(JB,366))                                             
      L = DD(JB,399)+ DW(JB,399)
     &+(RC(JB,847)    )                                                    
      Y(JB,399) = (YP(JB,399)+DTS*P)/(1.0+DTS*L)
C          P1064            Y(JB,400)
      P = 0.0
     &+(RC(JB,848)    *Y(JB,367))                                             
      L = DD(JB,400)+ DW(JB,400)
     &+(RC(JB,849)    )                                                    
      Y(JB,400) = (YP(JB,400)+DTS*P)/(1.0+DTS*L)
C          P1065            Y(JB,401)
      P = 0.0
     &+(RC(JB,850)    *Y(JB,368))                                             
      L = DD(JB,401)+ DW(JB,401)
     &+(RC(JB,851)    )                                                    
      Y(JB,401) = (YP(JB,401)+DTS*P)/(1.0+DTS*L)
C          P1066            Y(JB,402)
      P = 0.0
     &+(RC(JB,852)    *Y(JB,369))                                             
      L = DD(JB,402)+ DW(JB,402)
     &+(RC(JB,853)    )                                                    
      Y(JB,402) = (YP(JB,402)+DTS*P)/(1.0+DTS*L)
C          P1067            Y(JB,403)
      P = 0.0
     &+(RC(JB,854)    *Y(JB,370))                                             
      L = DD(JB,403)+ DW(JB,403)
     &+(RC(JB,855)    )                                                    
      Y(JB,403) = (YP(JB,403)+DTS*P)/(1.0+DTS*L)
C          P1068            Y(JB,404)
      P = 0.0
     &+(RC(JB,856)    *Y(JB,371))                                             
      L = DD(JB,404)+ DW(JB,404)
     &+(RC(JB,857)    )                                                    
      Y(JB,404) = (YP(JB,404)+DTS*P)/(1.0+DTS*L)
C          P1069            Y(JB,405)
      P = 0.0
     &+(RC(JB,858)    *Y(JB,372))                                             
      L = DD(JB,405)+ DW(JB,405)
     &+(RC(JB,859)    )                                                    
      Y(JB,405) = (YP(JB,405)+DTS*P)/(1.0+DTS*L)
C          P1070            Y(JB,406)
      P = 0.0
     &+(RC(JB,860)    *Y(JB,373))                                             
      L = DD(JB,406)+ DW(JB,406)
     &+(RC(JB,861)    )                                                    
      Y(JB,406) = (YP(JB,406)+DTS*P)/(1.0+DTS*L)
C          P1071            Y(JB,407)
      P = 0.0
     &+(RC(JB,862)    *Y(JB,374))                                             
      L = DD(JB,407)+ DW(JB,407)
     &+(RC(JB,863)    )                                                    
      Y(JB,407) = (YP(JB,407)+DTS*P)/(1.0+DTS*L)
C          P1072            Y(JB,408)
      P = 0.0
     &+(RC(JB,864)    *Y(JB,375))                                             
      L = DD(JB,408)+ DW(JB,408)
     &+(RC(JB,865)    )                                                    
      Y(JB,408) = (YP(JB,408)+DTS*P)/(1.0+DTS*L)
C          P1073            Y(JB,409)
      P = 0.0
     &+(RC(JB,866)    *Y(JB,376))                                             
      L = DD(JB,409)+ DW(JB,409)
     &+(RC(JB,867)    )                                                    
      Y(JB,409) = (YP(JB,409)+DTS*P)/(1.0+DTS*L)
C          P1074            Y(JB,410)
      P = 0.0
     &+(RC(JB,868)    *Y(JB,377))                                             
      L = DD(JB,410)+ DW(JB,410)
     &+(RC(JB,869)    )                                                    
      Y(JB,410) = (YP(JB,410)+DTS*P)/(1.0+DTS*L)
C          P1075            Y(JB,411)
      P = 0.0
     &+(RC(JB,870)    *Y(JB,378))                                             
      L = DD(JB,411)+ DW(JB,411)
     &+(RC(JB,871)    )                                                    
      Y(JB,411) = (YP(JB,411)+DTS*P)/(1.0+DTS*L)
C          P1076            Y(JB,412)
      P = 0.0
     &+(RC(JB,872)    *Y(JB,379))                                             
      L = DD(JB,412)+ DW(JB,412)
     &+(RC(JB,873)    )                                                    
      Y(JB,412) = (YP(JB,412)+DTS*P)/(1.0+DTS*L)
C          P1077            Y(JB,413)
      P = 0.0
     &+(RC(JB,874)    *Y(JB,380))                                             
      L = DD(JB,413)+ DW(JB,413)
     &+(RC(JB,875)    )                                                    
      Y(JB,413) = (YP(JB,413)+DTS*P)/(1.0+DTS*L)
C          P1078            Y(JB,414)
      P = 0.0
     &+(RC(JB,876)    *Y(JB,381))                                             
      L = DD(JB,414)+ DW(JB,414)
     &+(RC(JB,877)    )                                                    
      Y(JB,414) = (YP(JB,414)+DTS*P)/(1.0+DTS*L)
C          P1079            Y(JB,415)
      P = 0.0
     &+(RC(JB,878)    *Y(JB,382))                                             
      L = DD(JB,415)+ DW(JB,415)
     &+(RC(JB,879)    )                                                    
      Y(JB,415) = (YP(JB,415)+DTS*P)/(1.0+DTS*L)
C          P1080            Y(JB,416)
      P = 0.0
     &+(RC(JB,880)    *Y(JB,383))                                             
      L = DD(JB,416)+ DW(JB,416)
     &+(RC(JB,881)    )                                                    
      Y(JB,416) = (YP(JB,416)+DTS*P)/(1.0+DTS*L)
...
C
      ...
      REAL KOUT1046,KOUT1047,KOUT1048,KOUT1049,KOUT1050
      REAL KOUT1051,KOUT1052,KOUT1053,KOUT1054,KOUT1055
      REAL KOUT1056,KOUT1057,KOUT1058,KOUT1059,KOUT1060
      REAL KOUT1061,KOUT1062,KOUT1063,KOUT1064,KOUT1065
      REAL KOUT1066,KOUT1067,KOUT1068,KOUT1069,KOUT1070
      REAL KOUT1071,KOUT1072,KOUT1073,KOUT1074,KOUT1075
      REAL KOUT1076,KOUT1077,KOUT1078,KOUT1079,KOUT1080
...
C
      ...
      KOUT1048 = 2.065*EXP(-8597/(R*TC(JB)))
      KOUT1049 = 2.065*EXP(-12627/(R*TC(JB)))
      KOUT1050 = 2.065*EXP(-8026/(R*TC(JB)))
      KOUT1051 = 2.065*EXP(-10593/(R*TC(JB)))
      KOUT1052 = 2.065*EXP(-5692/(R*TC(JB)))
      KOUT1053 = 2.065*EXP(-21775/(R*TC(JB)))
      KOUT1054 = 2.065*EXP(-18824/(R*TC(JB)))
      KOUT1055 = 2.065*EXP(-1478/(R*TC(JB)))
      KOUT1056 = 2.065*EXP(-12590/(R*TC(JB)))
      KOUT1057 = 2.065*EXP(-21900/(R*TC(JB)))
      KOUT1058 = 2.065*EXP(-19951/(R*TC(JB)))
      KOUT1059 = 2.065*EXP(-14296/(R*TC(JB)))
      KOUT1060 = 2.065*EXP(-4147/(R*TC(JB)))
      KOUT1061 = 2.065*EXP(-27457/(R*TC(JB)))
      KOUT1062 = 2.065*EXP(-4375/(R*TC(JB)))
      KOUT1063 = 2.065*EXP(-26143/(R*TC(JB)))
      KOUT1064 = 2.065*EXP(-18040/(R*TC(JB)))
      KOUT1065 = 2.065*EXP(-8369/(R*TC(JB)))
      KOUT1066 = 2.065*EXP(-5745/(R*TC(JB)))
      KOUT1067 = 2.065*EXP(-15785/(R*TC(JB)))
      KOUT1068 = 2.065*EXP(-6144/(R*TC(JB)))
      KOUT1069 = 2.065*EXP(-27859/(R*TC(JB)))
      KOUT1070 = 2.065*EXP(-8312/(R*TC(JB)))
      KOUT1071 = 2.065*EXP(-24222/(R*TC(JB)))
      KOUT1072 = 2.065*EXP(-6201/(R*TC(JB)))
      KOUT1073 = 2.065*EXP(-29365/(R*TC(JB)))
      KOUT1074 = 2.065*EXP(-18873/(R*TC(JB)))
      KOUT1075 = 2.065*EXP(-2835/(R*TC(JB)))
      KOUT1076 = 2.065*EXP(-25321/(R*TC(JB)))
      KOUT1077 = 2.065*EXP(-7627/(R*TC(JB)))
      KOUT1078 = 2.065*EXP(-10137/(R*TC(JB)))
      KOUT1079 = 2.065*EXP(-11343/(R*TC(JB)))
      KOUT1080 = 2.065*EXP(-27537/(R*TC(JB)))
C
...
c      DATA DVLAND(53),DVSEA(53)   /5.0,  5.0/ ! MVKOOH
      ...
      DATA DVLAND(384),DVSEA(384) /2.0,  1.0/ ! P1048
      DATA DVLAND(385),DVSEA(385) /2.0,  1.0/ ! P1049
      DATA DVLAND(386),DVSEA(386) /2.0,  1.0/ ! P1050
      DATA DVLAND(387),DVSEA(387) /2.0,  1.0/ ! P1051
      DATA DVLAND(388),DVSEA(388) /2.0,  1.0/ ! P1052
      DATA DVLAND(389),DVSEA(389) /2.0,  1.0/ ! P1053
      DATA DVLAND(390),DVSEA(390) /2.0,  1.0/ ! P1054
      DATA DVLAND(391),DVSEA(391) /2.0,  1.0/ ! P1055
      DATA DVLAND(392),DVSEA(392) /2.0,  1.0/ ! P1056
      DATA DVLAND(393),DVSEA(393) /2.0,  1.0/ ! P1057
      DATA DVLAND(394),DVSEA(394) /2.0,  1.0/ ! P1058
      DATA DVLAND(395),DVSEA(395) /2.0,  1.0/ ! P1059
      DATA DVLAND(396),DVSEA(396) /2.0,  1.0/ ! P1060
      DATA DVLAND(397),DVSEA(397) /2.0,  1.0/ ! P1061
      DATA DVLAND(398),DVSEA(398) /2.0,  1.0/ ! P1062
      DATA DVLAND(399),DVSEA(399) /2.0,  1.0/ ! P1063
      DATA DVLAND(400),DVSEA(400) /2.0,  1.0/ ! P1064
      DATA DVLAND(401),DVSEA(401) /2.0,  1.0/ ! P1065
      DATA DVLAND(402),DVSEA(402) /2.0,  1.0/ ! P1066
      DATA DVLAND(403),DVSEA(403) /2.0,  1.0/ ! P1067
      DATA DVLAND(404),DVSEA(404) /2.0,  1.0/ ! P1068
      DATA DVLAND(405),DVSEA(405) /2.0,  1.0/ ! P1069
      DATA DVLAND(406),DVSEA(406) /2.0,  1.0/ ! P1070
      DATA DVLAND(407),DVSEA(407) /2.0,  1.0/ ! P1071
      DATA DVLAND(408),DVSEA(408) /2.0,  1.0/ ! P1072
      DATA DVLAND(409),DVSEA(409) /2.0,  1.0/ ! P1073
      DATA DVLAND(410),DVSEA(410) /2.0,  1.0/ ! P1074
      DATA DVLAND(411),DVSEA(411) /2.0,  1.0/ ! P1075
      DATA DVLAND(412),DVSEA(412) /2.0,  1.0/ ! P1076
      DATA DVLAND(413),DVSEA(413) /2.0,  1.0/ ! P1077
      DATA DVLAND(414),DVSEA(414) /2.0,  1.0/ ! P1078
      DATA DVLAND(415),DVSEA(415) /2.0,  1.0/ ! P1079
      DATA DVLAND(416),DVSEA(416) /2.0,  1.0/ ! P1080
C
...
C
      ...
      DATA DSC(384),CSC(384) / 5.0,  1.0/ ! P1048
      DATA DSC(385),CSC(385) / 5.0,  1.0/ ! P1049
      DATA DSC(386),CSC(386) / 5.0,  1.0/ ! P1050
      DATA DSC(387),CSC(387) / 5.0,  1.0/ ! P1051
      DATA DSC(388),CSC(388) / 5.0,  1.0/ ! P1052
      DATA DSC(389),CSC(389) / 5.0,  1.0/ ! P1053
      DATA DSC(390),CSC(390) / 5.0,  1.0/ ! P1054
      DATA DSC(391),CSC(391) / 5.0,  1.0/ ! P1055
      DATA DSC(392),CSC(392) / 5.0,  1.0/ ! P1056
      DATA DSC(393),CSC(393) / 5.0,  1.0/ ! P1057
      DATA DSC(394),CSC(394) / 5.0,  1.0/ ! P1058
      DATA DSC(395),CSC(395) / 5.0,  1.0/ ! P1059
      DATA DSC(396),CSC(396) / 5.0,  1.0/ ! P1060
      DATA DSC(397),CSC(397) / 5.0,  1.0/ ! P1061
      DATA DSC(398),CSC(398) / 5.0,  1.0/ ! P1062
      DATA DSC(399),CSC(399) / 5.0,  1.0/ ! P1063
      DATA DSC(400),CSC(400) / 5.0,  1.0/ ! P1064
      DATA DSC(401),CSC(401) / 5.0,  1.0/ ! P1065
      DATA DSC(402),CSC(402) / 5.0,  1.0/ ! P1066
      DATA DSC(403),CSC(403) / 5.0,  1.0/ ! P1067
      DATA DSC(404),CSC(404) / 5.0,  1.0/ ! P1068
      DATA DSC(405),CSC(405) / 5.0,  1.0/ ! P1069
      DATA DSC(406),CSC(406) / 5.0,  1.0/ ! P1070
      DATA DSC(407),CSC(407) / 5.0,  1.0/ ! P1071
      DATA DSC(408),CSC(408) / 5.0,  1.0/ ! P1072
      DATA DSC(409),CSC(409) / 5.0,  1.0/ ! P1073
      DATA DSC(410),CSC(410) / 5.0,  1.0/ ! P1074
      DATA DSC(411),CSC(411) / 5.0,  1.0/ ! P1075
      DATA DSC(412),CSC(412) / 5.0,  1.0/ ! P1076
      DATA DSC(413),CSC(413) / 5.0,  1.0/ ! P1077
      DATA DSC(414),CSC(414) / 5.0,  1.0/ ! P1078
      DATA DSC(415),CSC(415) / 5.0,  1.0/ ! P1079
      DATA DSC(416),CSC(416) / 5.0,  1.0/ ! P1080
...
C AIS -ALREADY IN STOCHEM
          ...
          P(144,J)=JCH3OOH(J)		!NRTX28OO
          P(145,J)=JCH3OOH(J)		!NRTX28OO
          P(146,J)=JCH3OOH(J)		!NRTX28OO
          P(147,J)=JCH3OOH(J)		!NRTX28OO
          P(148,J)=JCH3OOH(J)		!NRTX28OO
          P(149,J)=JCH3OOH(J)		!NRTX28OO
          P(150,J)=JCH3OOH(J)		!NRTX28OO
          P(151,J)=JCH3OOH(J)		!NRTX28OO
          P(152,J)=JCH3OOH(J)		!NRTX28OO
          P(153,J)=JCH3OOH(J)		!NRTX28OO
          P(154,J)=JCH3OOH(J)		!NRTX28OO
          P(155,J)=JCH3OOH(J)		!NRTX28OO
          P(156,J)=JCH3OOH(J)		!NRTX28OO
          P(157,J)=JCH3OOH(J)		!NRTX28OO
          P(158,J)=JCH3OOH(J)		!NRTX28OO
          P(159,J)=JCH3OOH(J)		!NRTX28OO
          P(160,J)=JCH3OOH(J)		!NRTX28OO
          P(161,J)=JCH3OOH(J)		!NRTX28OO
          P(162,J)=JCH3OOH(J)		!NRTX28OO
          P(163,J)=JCH3OOH(J)		!NRTX28OO
          P(164,J)=JCH3OOH(J)		!NRTX28OO
          P(165,J)=JCH3OOH(J)		!NRTX28OO
          P(166,J)=JCH3OOH(J)		!NRTX28OO
          P(167,J)=JCH3OOH(J)		!NRTX28OO
          P(168,J)=JCH3OOH(J)		!NRTX28OO
          P(169,J)=JCH3OOH(J)		!NRTX28OO
          P(170,J)=JCH3OOH(J)		!NRTX28OO
          P(171,J)=JCH3OOH(J)		!NRTX28OO
          P(172,J)=JCH3OOH(J)		!NRTX28OO
          P(173,J)=JCH3OOH(J)		!NRTX28OO
          P(174,J)=JCH3OOH(J)		!NRTX28OO
          P(175,J)=JCH3OOH(J)		!NRTX28OO
          P(176,J)=JCH3OOH(J)		!NRTX28OO
          P(177,J)=JCH3OOH(J)		!NRTX28OO
          P(178,J)=JCH3OOH(J)		!NRTX28OO
          P(179,J)=JCH3OOH(J)		!NRTX28OO
          P(180,J)=JCH3OOH(J)		!NRTX28OO
          P(181,J)=JCH3OOH(J)		!NRTX28OO
          P(182,J)=JCH3OOH(J)		!NRTX28OO
          P(183,J)=JCH3OOH(J)		!NRTX28OO
          P(184,J)=JCH3OOH(J)		!NRTX28OO
