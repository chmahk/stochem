...
C-----------------------------------------------------------------------
     ...
     &     RC(NBLOCK,NR),XX(NC,NBLOCK),ASTEP,KH(NBLOCK,5),KE(NBLOCK,6)
      ...
      REAL FLUX(NBLOCK,1700),POS(3,NBLOCK),LL(NBLOCK),N2(NBLOCK)
	...
	DOUBLE PRECISION P09M(NBLOCK),P10M(NBLOCK),P11M(NBLOCK),
     ...
     &     C2H4,C3H6,CVF
      ...
      REAL SOA(NBLOCK),MOM(NBLOCK),XOX(NBLOCK),YOY(NBLOCK),ZOZ(NBLOCK)
      LOGICAL CELLBUD
...
C          H2               Y(JB, 10)
     ...
     &+(DJ(JB,10)     *Y(JB,39 ))                                             
      L = DD(JB,10)+DW(JB,10)
     &+(RC(JB,18)     *Y(JB,3  ))+(DJ(JB,107)*Y(JB,60))                                             
...
C       O + NO = NO2
      FLUX(JB,4)=FLUX(JB,4)+RC(JB,4)*Y(JB,2)*Y(JB,8)*DTS/M(JB)
C      O + NO2 = NO
...
C
      DO 1020 JB=1,NBLOCK
C        O3 + hv = OD
        FLUX(JB,601)=FLUX(JB,601)+DJ(JB,1)*Y(JB,6)*DTS/M(JB)
C        O3 + hv = O
        FLUX(JB,602)=FLUX(JB,602)+DJ(JB,2)*Y(JB,6)*DTS/M(JB)
C        H2O2 + hv = OH + OH
        FLUX(JB,603)=FLUX(JB,603)+DJ(JB,3)*Y(JB,12)*DTS/M(JB)
C        NO2 + hv = NO + OP
        FLUX(JB,604)=FLUX(JB,604)+DJ(JB,4)*Y(JB,4)*DTS/M(JB)
C        NO3 + hv = NO
        FLUX(JB,605)=FLUX(JB,605)+DJ(JB,5)*Y(JB,5)*DTS/M(JB)
C        NO3 + hv = NO2 + OP
        FLUX(JB,606)=FLUX(JB,606)+DJ(JB,6)*Y(JB,5)*DTS/M(JB)
C        HONO + hv  = OH + NO
        FLUX(JB,607)=FLUX(JB,607)+DJ(JB,7)*Y(JB,13)*DTS/M(JB)
C        HNO3 + hv = NO2 + OH
        FLUX(JB,608)=FLUX(JB,608)+DJ(JB,8)*Y(JB,14)*DTS/M(JB)
C        HCHO + hv = CO + HO2 + HO2
        FLUX(JB,609)=FLUX(JB,609)+DJ(JB,9)*Y(JB,39)*DTS/M(JB)
C        HCHO + hv = CO + H2
        FLUX(JB,610)=FLUX(JB,610)+DJ(JB,10)*Y(JB,39)*DTS/M(JB)
C        CH3CHO + hv = CH3O2 + HO2 + CO
        FLUX(JB,611)=FLUX(JB,611)+DJ(JB,11)*Y(JB,42)*DTS/M(JB)
C      C2H5CHO = C2H5O2 + CO + HO2
        FLUX(JB,612)=FLUX(JB,612)+DJ(JB,12)*Y(JB,71)*DTS/M(JB)
C        CH3COCH3 + hv = CH3COO2 + CH3O2
        FLUX(JB,613)=FLUX(JB,613)+DJ(JB,13)*Y(JB,73)*DTS/M(JB)
C       MEK = CH3CO3 + C2H5O2 
        FLUX(JB,614)=FLUX(JB,614)+DJ(JB,14)*Y(JB,101)*DTS/M(JB)
C       CARB14 + CH3CO3 + RN10O2
        FLUX(JB,615)=FLUX(JB,615)+DJ(JB,15)*Y(JB,186)*DTS/M(JB)
C       CARB17->RN8O2+RN10O2 
        FLUX(JB,616)=FLUX(JB,616)+DJ(JB,16)*Y(JB,187)*DTS/M(JB)
C       CARB11A->CH3CO3+C2H5O2
        FLUX(JB,617)=FLUX(JB,617)+DJ(JB,17)*Y(JB,88)*DTS/M(JB)
C       CARB7->CH3CO3+HCHO+HO2    
        FLUX(JB,618)=FLUX(JB,618)+DJ(JB,18)*Y(JB,111)*DTS/M(JB)
C       CARB10->CH3CO3+CH3CHO+HO2 
        FLUX(JB,619)=FLUX(JB,619)+DJ(JB,19)*Y(JB,188)*DTS/M(JB)
C       CARB13->RN8O2+CH3CHO+HO2
        FLUX(JB,620)=FLUX(JB,620)+DJ(JB,20)*Y(JB,104)*DTS/M(JB)
C       CARB16->RN8O2+C2H5CHO+HO2
        FLUX(JB,621)=FLUX(JB,621)+DJ(JB,21)*Y(JB,105)*DTS/M(JB)
C       HOCH2CHO->HCHO+CO+HO2+HO2
        FLUX(JB,622)=FLUX(JB,622)+DJ(JB,22)*Y(JB,102)*DTS/M(JB)
C       UCARB10->CH3CO3+HCHO+HO2
        FLUX(JB,623)=FLUX(JB,623)+DJ(JB,23)*Y(JB,46)*DTS/M(JB)
C       CARB3->CO+CO+HO2+HO2
        FLUX(JB,624)=FLUX(JB,624)+DJ(JB,24)*Y(JB,60)*DTS/M(JB)
C       CARB6->CH3CO3+CO+HO2 
        FLUX(JB,625)=FLUX(JB,625)+DJ(JB,25)*Y(JB,98)*DTS/M(JB)
C       CARB9->CH3CO3+CH3CO3
        FLUX(JB,626)=FLUX(JB,626)+DJ(JB,26)*Y(JB,100)*DTS/M(JB)
C       CARB12->CH3CO3+RN8O2
        FLUX(JB,627)=FLUX(JB,627)+DJ(JB,27)*Y(JB,189)*DTS/M(JB)
C       CARB15->RN8O2+RN8O2
        FLUX(JB,628)=FLUX(JB,628)+DJ(JB,28)*Y(JB,190)*DTS/M(JB)
C       UCARB12->CH3CO3+HOCH2CHO+CO+HO2
        FLUX(JB,629)=FLUX(JB,629)+DJ(JB,29)*Y(JB,109)*DTS/M(JB)
C       NUCARB12->HUCARB9+CO+OH+NO2
        FLUX(JB,630)=FLUX(JB,630)+DJ(JB,30)*Y(JB,113)*DTS/M(JB)
C       NUCARB12->CARB7+CO+CO+HO2+NO2
        FLUX(JB,631)=FLUX(JB,631)+DJ(JB,31)*Y(JB,113)*DTS/M(JB)
C       RU12NO3->CARB6+HOCH2CHO+HO2+NO2
        FLUX(JB,632)=FLUX(JB,632)+DJ(JB,32)*Y(JB,235)*DTS/M(JB)
C       UDCARB8->C2H5O2+HO2
        FLUX(JB,633)=FLUX(JB,633)+DJ(JB,33)*Y(JB,96)*DTS/M(JB)
C       UDCARB8->ANHY+HO2+HO2
        FLUX(JB,634)=FLUX(JB,634)+DJ(JB,34)*Y(JB,96)*DTS/M(JB)
C       UDCARB11->RN10O2+HO2
        FLUX(JB,635)=FLUX(JB,635)+DJ(JB,35)*Y(JB,97)*DTS/M(JB)
C       UDCARB11->ANHY+HO2+CH3O2
        FLUX(JB,636)=FLUX(JB,636)+DJ(JB,36)*Y(JB,97)*DTS/M(JB)
C       UDCARB14->RN13O2+HO2
        FLUX(JB,637)=FLUX(JB,637)+DJ(JB,37)*Y(JB,99)*DTS/M(JB)
C       UDCARB14->ANHY+HO2+C2H5O2
        FLUX(JB,638)=FLUX(JB,638)+DJ(JB,38)*Y(JB,99)*DTS/M(JB)
C       TNCARB26->RTN26O2+HO2
        FLUX(JB,639)=FLUX(JB,639)+DJ(JB,39)*Y(JB,51)*DTS/M(JB)
C       TNCARB10->CH3CO3+CH3CO3+CO
        FLUX(JB,640)=FLUX(JB,640)+DJ(JB,40)*Y(JB,120)*DTS/M(JB)
C       CH3NO3->HCHO+HO2+NO2
        FLUX(JB,641)=FLUX(JB,641)+DJ(JB,41)*Y(JB,123)*DTS/M(JB)
C       C2H5NO3->CH3CHO+HO2+NO2
        FLUX(JB,642)=FLUX(JB,642)+DJ(JB,42)*Y(JB,124)*DTS/M(JB)
C       RN10NO3->C2H5CHO+HO2+NO2
        FLUX(JB,643)=FLUX(JB,643)+DJ(JB,43)*Y(JB,125)*DTS/M(JB)
C       IC3H7NO3->CH3COCH3+HO2+NO2
        FLUX(JB,644)=FLUX(JB,644)+DJ(JB,44)*Y(JB,126)*DTS/M(JB)
C       RN13NO3->CH3CHO+C2H5O2+NO2
        FLUX(JB,645)=FLUX(JB,645)+DJ(JB,45)*Y(JB,127)*DTS/M(JB)
C       RN13NO3->CARB11A+HO2+NO2
        FLUX(JB,646)=FLUX(JB,646)+DJ(JB,46)*Y(JB,127)*DTS/M(JB)
C       RN16NO3->RN15O2+NO2
        FLUX(JB,647)=FLUX(JB,647)+DJ(JB,47)*Y(JB,128)*DTS/M(JB)
C       RN19NO3->RN18O2+NO2
        FLUX(JB,648)=FLUX(JB,648)+DJ(JB,48)*Y(JB,129)*DTS/M(JB)
C       RA13NO3->CARB3+UDCARB8+HO2+NO2
        FLUX(JB,649)=FLUX(JB,649)+DJ(JB,49)*Y(JB,136)*DTS/M(JB)
C       RA16NO3->CARB3+UDCARB11+HO2+NO2
        FLUX(JB,650)=FLUX(JB,650)+DJ(JB,50)*Y(JB,137)*DTS/M(JB)
C       RA19NO3->CARB6+UDCARB11+HO2+NO2
        FLUX(JB,651)=FLUX(JB,651)+DJ(JB,51)*Y(JB,138)*DTS/M(JB)
C       RTX24NO3->TXCARB22+HO2+NO2
        FLUX(JB,652)=FLUX(JB,652)+DJ(JB,52)*Y(JB,142)*DTS/M(JB)
C       CH3OOH->HCHO+HO2+OH
        FLUX(JB,653)=FLUX(JB,653)+DJ(JB,53)*Y(JB,144)*DTS/M(JB)
C       C2H5OOH->CH3CHO+HO2+OH
        FLUX(JB,654)=FLUX(JB,654)+DJ(JB,54)*Y(JB,145)*DTS/M(JB)
C       RN10OOH->C2H5CHO+HO2+OH
        FLUX(JB,655)=FLUX(JB,655)+DJ(JB,55)*Y(JB,146)*DTS/M(JB)
C       IC3H7OOH->CH3COCH3+HO2+OH
        FLUX(JB,656)=FLUX(JB,656)+DJ(JB,56)*Y(JB,147)*DTS/M(JB)
C       RN13OOH->CH3CHO+C2H5O2+OH
        FLUX(JB,657)=FLUX(JB,657)+DJ(JB,57)*Y(JB,148)*DTS/M(JB)
C       RN13OOH->CARB11A+HO2+OH
        FLUX(JB,658)=FLUX(JB,658)+DJ(JB,58)*Y(JB,148)*DTS/M(JB)
C       RN16OOH->RN15AO2+OH
        FLUX(JB,659)=FLUX(JB,659)+DJ(JB,59)*Y(JB,149)*DTS/M(JB)
C       RN19OOH->RN18AO2+OH
        FLUX(JB,660)=FLUX(JB,660)+DJ(JB,60)*Y(JB,150)*DTS/M(JB)
C       CH3CO3H->CH3O2+OH
        FLUX(JB,661)=FLUX(JB,661)+DJ(JB,61)*Y(JB,159)*DTS/M(JB)
C       C2H5CO3H->C2H5O2+OH
        FLUX(JB,662)=FLUX(JB,662)+DJ(JB,62)*Y(JB,160)*DTS/M(JB)
C       HOCH2CO3H->HCHO+HO2+OH
        FLUX(JB,663)=FLUX(JB,663)+DJ(JB,63)*Y(JB,161)*DTS/M(JB)
C       RN8OOH->CH3CO3+HCHO+OH
        FLUX(JB,664)=FLUX(JB,664)+DJ(JB,64)*Y(JB,162)*DTS/M(JB)
C       RN11OOH->RN10O2+OH
        FLUX(JB,665)=FLUX(JB,665)+DJ(JB,65)*Y(JB,163)*DTS/M(JB)
C       RN14OOH->RN13O2+OH
        FLUX(JB,666)=FLUX(JB,666)+DJ(JB,66)*Y(JB,164)*DTS/M(JB)
C       RN17OOH->RN16O2+OH
        FLUX(JB,667)=FLUX(JB,667)+DJ(JB,67)*Y(JB,165)*DTS/M(JB)
C       UCARB12=RU12O2+HO2
        FLUX(JB,668)=FLUX(JB,668)+DJ(JB,68)*Y(JB,109)*DTS/M(JB)
C       UCARB12=CARB7+CO+CO+HO2+HO2
        FLUX(JB,669)=FLUX(JB,669)+DJ(JB,69)*Y(JB,109)*DTS/M(JB)
C       RU12OOH->CARB6+HOCH2CHO+HO2+OH
        FLUX(JB,670)=FLUX(JB,670)+DJ(JB,70)*Y(JB,167)*DTS/M(JB)
C       RU10OOH->CH3CO3+HOCH2CHO+OH
        FLUX(JB,671)=FLUX(JB,671)+DJ(JB,71)*Y(JB,168)*DTS/M(JB)
C       NRU14OOH->NUCARB12+HO2+OH
        FLUX(JB,672)=FLUX(JB,672)+DJ(JB,72)*Y(JB,172)*DTS/M(JB)
C       NRU12OOH->NOA+CARB3+HO2+OH
        FLUX(JB,673)=FLUX(JB,673)+DJ(JB,73)*Y(JB,173)*DTS/M(JB)
C       HOC2H4OOH->HCHO+HCHO+HO2+OH
        FLUX(JB,674)=FLUX(JB,674)+DJ(JB,74)*Y(JB,154)*DTS/M(JB)
C       RN9OOH->CH3CHO+HCHO+HO2+OH
        FLUX(JB,675)=FLUX(JB,675)+DJ(JB,75)*Y(JB,155)*DTS/M(JB)
C       RN12OOH->CH3CHO+CH3CHO+HO2+OH
        FLUX(JB,676)=FLUX(JB,676)+DJ(JB,76)*Y(JB,156)*DTS/M(JB)
C       RN15OOH->C2H5CHO+CH3CHO+HO2+OH
        FLUX(JB,677)=FLUX(JB,677)+DJ(JB,77)*Y(JB,157)*DTS/M(JB)
C       RN18OOH->C2H5CHO+C2H5CHO+HO2+OH
        FLUX(JB,678)=FLUX(JB,678)+DJ(JB,78)*Y(JB,158)*DTS/M(JB)
C       NRN6OOH->HCHO+HCHO+NO2+OH
        FLUX(JB,679)=FLUX(JB,679)+DJ(JB,79)*Y(JB,169)*DTS/M(JB)
C       NRN9OOH->CH3CHO+HCHO+NO2+OH
        FLUX(JB,680)=FLUX(JB,680)+DJ(JB,80)*Y(JB,170)*DTS/M(JB)
C       NRN12OOH->CH3CHO+CH3CHO+NO2+OH
        FLUX(JB,681)=FLUX(JB,681)+DJ(JB,81)*Y(JB,171)*DTS/M(JB)
C       RA13OOH->CARB3+UDCARB8+HO2+OH
        FLUX(JB,682)=FLUX(JB,682)+DJ(JB,82)*Y(JB,151)*DTS/M(JB)
C       RA16OOH->CARB3+UDCARB11+HO2+OH
        FLUX(JB,683)=FLUX(JB,683)+DJ(JB,83)*Y(JB,152)*DTS/M(JB)
C       RA19OOH->CARB6+UDCARB11+HO2+OH
        FLUX(JB,684)=FLUX(JB,684)+DJ(JB,84)*Y(JB,153)*DTS/M(JB)
C       RTN28OOH->TNCARB26+HO2+OH
        FLUX(JB,685)=FLUX(JB,685)+DJ(JB,85)*Y(JB,174)*DTS/M(JB)
C       NRTN28OOH->TNCARB26+NO2+OH
        FLUX(JB,686)=FLUX(JB,686)+DJ(JB,86)*Y(JB,175)*DTS/M(JB)
C       RTN26OOH->RTN25O2+OH
        FLUX(JB,687)=FLUX(JB,687)+DJ(JB,87)*Y(JB,176)*DTS/M(JB)
C       RTN25OOH->RTN24O2+OH
        FLUX(JB,688)=FLUX(JB,688)+DJ(JB,88)*Y(JB,177)*DTS/M(JB)
C       RTN24OOH->RTN23O2+OH
        FLUX(JB,689)=FLUX(JB,689)+DJ(JB,89)*Y(JB,178)*DTS/M(JB)
C       RTN23OOH->CH3COCH3+RTN14O2+OH
        FLUX(JB,690)=FLUX(JB,690)+DJ(JB,90)*Y(JB,179)*DTS/M(JB)
C       RTN14OOH->TNCARB10+HCHO+HO2+OH
        FLUX(JB,691)=FLUX(JB,691)+DJ(JB,91)*Y(JB,180)*DTS/M(JB)
C       RTN10OOH->RN8O2+CO+OH
        FLUX(JB,692)=FLUX(JB,692)+DJ(JB,92)*Y(JB,181)*DTS/M(JB)
C       RTX28OOH->TXCARB24+HCHO+HO2+OH
        FLUX(JB,693)=FLUX(JB,693)+DJ(JB,93)*Y(JB,182)*DTS/M(JB)
C       RTX24OOH->TXCARB22+HO2+OH
        FLUX(JB,694)=FLUX(JB,694)+DJ(JB,94)*Y(JB,183)*DTS/M(JB)
C       TX22OOH->CH3COCH3+RN13O2+OH
        FLUX(JB,695)=FLUX(JB,695)+DJ(JB,95)*Y(JB,184)*DTS/M(JB)
C       NRTX28OOH->TXCARB24+HCHO+NO2+OH
        FLUX(JB,696)=FLUX(JB,696)+DJ(JB,96)*Y(JB,185)*DTS/M(JB)
C       HPUCARB12->HUCARB9+CO+OH+OH
        FLUX(JB,697)=FLUX(JB,697)+DJ(JB,97)*Y(JB,230)*DTS/M(JB)
C       HPUCARB12->CARB7+CO+CO+HO2+OH
        FLUX(JB,698)=FLUX(JB,698)+DJ(JB,98)*Y(JB,230)*DTS/M(JB)
C       DHPCARB9->RN8OOH+CO+HO2+OH
        FLUX(JB,699)=FLUX(JB,699)+DJ(JB,99)*Y(JB,233)*DTS/M(JB)
C       DHPCARB9->CARB6+HCHO+OH+OH
        FLUX(JB,700)=FLUX(JB,700)+DJ(JB,100)*Y(JB,233)*DTS/M(JB)
C       DHPR12OOH->DHPCARB9+CO+OH+HO2
        FLUX(JB,701)=FLUX(JB,701)+DJ(JB,101)*Y(JB,232)*DTS/M(JB)
C       DHPR12OOH->CARB3+RN8OOH+OH+OH
        FLUX(JB,702)=FLUX(JB,702)+DJ(JB,102)*Y(JB,232)*DTS/M(JB)
C       HUCARB9->CARB6+CO+HO2+OH
        FLUX(JB,703)=FLUX(JB,703)+DJ(JB,103)*Y(JB,234)*DTS/M(JB)
C       RU14NO3->UCARB10+HCHO+HO2+NO2
        FLUX(JB,704)=FLUX(JB,704)+DJ(JB,104)*Y(JB,135)*DTS/M(JB)
C       RU10NO3->CH3CO3+HOCH2CHO+NO2
        FLUX(JB,705)=FLUX(JB,705)+DJ(JB,105)*Y(JB,236)*DTS/M(JB)
C       DHCARB9->CARB7+CO+HO2+HO2
        FLUX(JB,706)=FLUX(JB,706)+DJ(JB,106)*Y(JB,238)*DTS/M(JB)
C       CARB3=CO+CO+H2
        FLUX(JB,707)=FLUX(JB,707)+DJ(JB,107)*Y(JB,60)*DTS/M(JB)
C       CARB3=HCHO+CO
        FLUX(JB,708)=FLUX(JB,708)+DJ(JB,108)*Y(JB,60)*DTS/M(JB)
C
C      -------------------------
...
C
        DO 1010 I=1,NC
          FLUX(JB,800+I)=FLUX(JB,800+I)+EM(JB,I)*DTS/M(JB)
          FLUX(JB,1100+I)=FLUX(JB,1100+I)+Y(JB,I)*DD(JB,I)*DTS/M(JB)
          FLUX(JB,1400+I)=FLUX(JB,1400+I)+Y(JB,I)*DW(JB,I)*DTS/M(JB)
 1010   CONTINUE
 1020 CONTINUE
C
C      debug concentrations for one cell.
...
C
      ...
      REAL XOX(NBLOCK),YOY(NBLOCK),ZOZ(NBLOCK)
      REAL K0,KI,F
      ...
      REAL KE0,KEI,KRE,FCE,FE
      REAL KF0,KFI,KRF,FCF,FF
...
C     K16ISOM
      KNO     = KRO2NO*XOX(JB) 
      KHO2    = KRO2HO2*YOY(JB)*0.706    
      KRO2    = 1.26D-12*RO2(JB)    
      KNO3    = KRO2NO3*ZOZ(JB)       
      KTR     = KNO+KHO2+KRO2+KNO3
      K16ISOM=(KTR*5.18D-4*EXP(1308/TC(JB)))+(2.76D+7*EXP(-6759/TC(JB))) 
C    KFPAN                                                   
C                                                                     
      KC0     = 3.28D-28*M(JB)*(TC(JB)/300)**-7.1 
      KCI     = 1.125D-11*(TC(JB)/300)**-1.105    
      KRC     = KC0/KCI    
      FCC     = 0.30       
...
C                                                                   
C    KBPAN                                                   
      KD0     = 1.1D-05*M(JB)*EXP(-10100/TC(JB)) 
      KDI     = 1.9D+17*EXP(-14100/TC(JB))  
      KRD     = KD0/KDI    
      FCD     = 0.30       
...
C    KFPPN                                                   
C                                                                     
      KE0     = 1.05D-27*M(JB)*(TC(JB)/300)**-6.87 
      KEI     = 1.125D-11*(TC(JB)/300)**-1.105     
      KRE     = KE0/KEI    
      FCE     = 0.36      
      FE      = 10**(LOG10(FCE)/(1+(LOG10(KRE))**2)) 
      KFPPN   = (KE0*KEI)*FE/(KE0+KEI) 
C                                                                   
C    KBPPN                                                   
      KF0     = 1.7D-03*M(JB)*EXP(-11280/TC(JB)) 
      KFI     = 8.3D+16*EXP(-13940/TC(JB))  
      KRF     = KF0/KFI    
      FCF     = 0.36       
      FF      = 10**(LOG10(FCF)/(1+(LOG10(KRF))**2)) 
      KBPPN   = (KF0*KFI)*FF/(KF0+KFI) 
...
C     Reaction (471) HOCH2CO3 + NO2 = PHAN                                              
         RC(JB,471) = 1.125D-11*(TC(JB)/300)**-1.105                        
C
C     Reaction (472) PHAN = HOCH2CO3 + NO2                                              
         RC(JB,472) = 5.2D16*EXP(-13850/TC(JB))                       
C
...
C     Reaction (479) MPAN = MACO3 + NO2                                                
         RC(JB,479) = 5.20D+16*EXP(-13850/TC(JB))                   
C
...
C     Reaction (482) RTN26O2 + NO2 = RTN26PAN                                           
         RC(JB,482) =  1.125D-11*(TC(JB)/300)**-1.105 *0.722       
C
C     Reaction (483) RTN26PAN = RTN26O2 + NO2                                           
         RC(JB,483) = 5.2D16*EXP(-13850/TC(JB))                   
C
...
C     Reaction (571) : MACO3 +NO2 = MPAN
       RC(JB,571) =  1.125D-11*(TC(JB)/300)**-1.105
...
C                                  Anth  ,Biomass,Veg   ,Soil  ,Oceans
      ...
      DATA (CLASS(IC,73),IC=1,5)  /0.297,  1.83,  15.0, 0.0,  0.0 / ! ACETONE
